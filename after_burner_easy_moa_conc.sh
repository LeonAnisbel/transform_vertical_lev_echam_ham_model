...
cdo expr,MOA_tot=POL_AS+PRO_AS+LIP_AS tmpnonzeros.nc tmpsum.nc
cdo selname,rhoam1 ${fnm1}_vphysc.nc tmpdens.nc
cdo merge tmpsum.nc tmpdens.nc tmpmix.nc

cdo expr,MOA=MOA_tot*rhoam1 tmpmix.nc tmpmoa.nc
cdo setunit,'kg/m3' -setcode,157 -selname,MOA tmpmoa.nc tmp1.nc
